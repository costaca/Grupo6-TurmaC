...
static int escolhaclasse, ConfirmarClasseVita, escolhaAtaque;//Escolha Classe
static String nick;
//Atributos Usuario
static int HpUsuario = 150;
static int AtqUsuario = 8;
static int HeUsuario = 5; //cura
...
static void historia02(){
  ...
  System.out.println("|                                                                                             |");
  System.out.println("|  " + nick + " acorda desorientado e levanta, ao seu redor só resta destruição e caos,       |");
  System.out.println("|            " + nick + " se concentra em buscar recursos para sobreviver.                    |");
  System.out.println("|             Ele tenta encontrar seus companheiros, mas todos a volta estão mortos,          |");
  System.out.println("|        os inimigos que sobrevivem estão feridos. " + nick + " tenta se comunicar,           |");
  System.out.println("|                        porém seus meios de comunicação não funcionam...                     |");
  System.out.println("|=============================================================================================|");
  tecleParaContinuar();
  System.out.println("                                        *CAPÍTULO 2*");
  System.out.println("|=============================================================================================|");
  System.out.println("| " + nick + " Decide seguir em frente para encontrar algum local seguro e prosseguir com a missão, |");
  ...
  System.out.println("|                                                                                             |");
  System.out.println("|      " + nick + " decide ajudá-lo, mesmo Ronam pedindo que vá embora, pois poderia ser visto.     |");
  System.out.println("|                          " + nick + " se recusa a deixar Ronam para trás,                         |");
  ...
  System.out.println("|                             " + nick + " e Ronam decidem carregá-la.                              |");
  System.out.println("|                                                                                             |");
  ...
  System.out.println("|                " + nick + " e Ronam decidem enfrentar o pequeno grupo de inimigos.                |");
  System.out.println("|                                                                                             |");
...
static void historia03(){
  ...
  System.out.println("|                                                                                             |");
  System.out.println("|                    " + nick + " se depara com um inimigo diferente dos demais,                    |"); 
...
static void historia04(){
  ...
  System.out.println("                                        *CAPÍTULO 4*");
  System.out.println("|=============================================================================================|");
  System.out.println("|                             E assim " + nick + " e seus companheiros,                             |");
  ...
  System.out.println("|                 um outro inimigo surge atrás de " + nick + " com intenção de derrubá-lo.          |");
  System.out.println("|                                                                                             |");
...
static void historia05(){
  ...
  System.out.println("|=============================================================================================|");
  System.out.println("|            Após se livrar de alguns inimigos Zoe, Ronam e " + nick + " percebem que               |");
...
static void historia07(){
  ...
  System.out.println("|                                                                                             |");
  System.out.println("|                   " + nick + ", Ronam e Zoe serão mandados para capital Vitron,                    |");
  ...
  System.out.println("|                         " + nick + " Zoe e Ronam descansaram no caminho,                          |");
  ...
  System.out.println("|                                                                                             |");
  System.out.println("|                    " + nick + ", Zoe Ronam, estudam a área e planejam o ataque,                    |"); 
...
static void historia09(){
 ...
 System.out.println("|                   Todos estão salvos agora, graças a " + nick + ", Ronam e Zoe.                   |");
 System.out.println("|                        Vitron está a salvo e não está mais em Guerra...                     |");
 System.out.println("|=============================================================================================|");
 tecleParaContinuar();
 System.out.println("                                        *CAPÍTULO FINAL*");
 System.out.println("|=============================================================================================|");
 System.out.println("|                        " + nick + " se depara com Ronam gravemente ferido.                        |");
 ...
 System.out.println("|                          " + nick + " e Zoe prestam homenagem a Ronam,                            |");
...
//Quadro Inserir NickName
static void quadroNickname(){
  ...
  System.out.println("|===================================================================================================|");
  System.out.println("|                                                                                                   |");
  System.out.println("|                             Olá " + nick + " Seja bem vindo a Viper.                              |");
  System.out.println("|                                                                                                   |");
  System.out.println("|===================================================================================================|");
}
//Fim do Quadro Nickname
...
nomeviper(); //Slogan
 do{ //Laço Menu Inicial
  ...
  opcaomenu = entrada.nextInt();
   switch(opcaomenu){
    case 1: //Opção: Jogar
     //criar outro quadro de inserção de nick, criar a variavel de nick, inserir o nick no lugar de "PLAYER" na história
       quadroNickname();
       quadroIntroducao();
       inimigo_at= 0; //Reset
       historia_at= 1;
